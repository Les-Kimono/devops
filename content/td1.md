...
![Dashboard Render](images/td1/1.png)
...
![Utilisateur IAM créé](images/td1/user_iam_created.png)
...
Intuitivement, j'ai consulté les logs de la console de l'instance pour comprendre ce qui se passait et il s'est avéré que le code fourni dans le .pdf du TD contenait une erreur de syntaxe, les commentaires en JavaScript ne sont pas déterminés par les symboles `#`, donc l'application Node plantait en rencontrant un `#`.

![Code copié ne marche pas](images/td1/code_copie_ne_marche_pas.png)
...
![Instance EC2 stoppée](images/td1/instance_stoppe.png)